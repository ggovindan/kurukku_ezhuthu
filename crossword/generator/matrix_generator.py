import random
import tamil
from generator.utils import ACROSS, DOWN, calculate_next_pos, will_fit, length, find_all_char_pos, calculate_free_rows, get_letters
from generator.utils import print_matrix, find_intersection
import json
