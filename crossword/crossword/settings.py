...
SECRET_KEY = 'v6ey(@-=5_2gz=rnwqzx))&8awkhivc0p178+$fsrmp!9d*h_7'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'kurukku/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = ''
STATIC_URL = '/static/'
STATICFILES_DIRS = ( os.path.join(BASE_DIR, 'kurukku/static', ), )